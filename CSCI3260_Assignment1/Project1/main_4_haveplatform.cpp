...
void paintGL(void) {
	...
	glm::mat4 viewMatrix = glm::lookAt(glm::vec3(0.0f, 60.0f, 12.0f),
		glm::vec3(0.0, 35.0f, 0.0f),
	...
	{
		glm::mat4 modelTransformMatrix = glm::mat4(1.0f);
		modelTransformMatrix = glm::translate(modelTransformMatrix, glm::vec3(0.0f, -2.5f, 2.0f));
		glUniformMatrix4fv(modelTransformMatrixUniformLocation, 1, GL_FALSE, &modelTransformMatrix[0][0]);
		glBindVertexArray(VAO[1]);
