...
void paintGL(void) {
	...
	//select box
	{
		...
		switch (current_pos) {
			case 0:
				modelTransformMatrix = glm::translate(modelTransformMatrix, glm::vec3(-24.0f, 0.0f, -30.0f));
				break;
			case 1:
			...
			case 2:
				...
				break;
			case 3:
				modelTransformMatrix = glm::translate(modelTransformMatrix, glm::vec3(-24.0f, 0.0f, -15.0f));
				break;
			case 4:
			...
			case 5:
				...
				break;
			case 6:
				modelTransformMatrix = glm::translate(modelTransformMatrix, glm::vec3(-24.0f, 0.0f, 1.0f));
				break;
			case 7:
